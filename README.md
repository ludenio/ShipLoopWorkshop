...
The left column is a shared library for company and scenario templates. Search by purpose, then edit the block's text, inputs, and outputs. It holds three kinds of blocks: a **Trigger** starts a run; **Agents** understand a task, do it, refine a result, or review one; **Variables** hold the task, context, acceptance criteria, result, feedback, measurements, and environment configuration.
